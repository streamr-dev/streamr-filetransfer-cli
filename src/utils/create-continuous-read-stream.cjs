...
module.exports = createContinuousReadStream
module.exports.createReadStream = createContinuousReadStream

function createContinuousReadStream(path, options) {
  ...
  ds._read = once(function () {
    ...
    // Todo pass chunk size as an option from CLI
    ...
    .once('open', function () {
      ...
      if (tail) {
        watcher = fs.watchFile(path, function (eventType, fileName) {
